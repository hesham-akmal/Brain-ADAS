...
class VehicleClient:
    ...
    def simGetImages(self, requests, vehicle_name=''):
        responses_raw = self.client.call('simGetImages', requests,
                vehicle_name)
        return [ImageResponse.from_msgpack(response_raw)
    ...
    def simGetGroundTruthKinematics(self, vehicle_name=''):
        return self.client.call('simGetGroundTruthKinematics',
                                vehicle_name)

    simGetGroundTruthKinematics.__annotations__ = \
        {'return': KinematicsState}

    def simGetGroundTruthEnvironment(self, vehicle_name=''):
        return self.client.call('simGetGroundTruthEnvironment',
                                vehicle_name)
...
class CarClient(VehicleClient, object):
    ...
    def getEventNumber(self, vehicle_name=''):
        eventnum = self.client.call('getEventNumber', vehicle_name)
        return eventnum
