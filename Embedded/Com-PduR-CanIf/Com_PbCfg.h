...
#define COM_PDU_ID_CANIF_RX_COM_MESSAGE_1  1
#define COM_PDU_ID_COM_TX_CANIF_MESSAGE_2  2
#define COM_PDU_ID_CANTP_RX_COM_MESSAGE_3  3
#define COM_PDU_ID_COM_TX_CANTP_MESSAGE_4  4
