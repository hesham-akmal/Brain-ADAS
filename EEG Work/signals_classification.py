...
from signals_visualization import mean_zero
import numpy as np
import pandas as pd
...
def classify_diff_intervals(fnames, electrodes, filter_apply, fc):
    LDAClassifier = LinearDiscriminantAnalysis(n_components=2)
    ...
    for f in fnames:
        ...
        for i in np.arange(12, 180, 12):
            ...
            if(filter_apply):
                pos, neg = apply_filter(pos, neg, fc)
